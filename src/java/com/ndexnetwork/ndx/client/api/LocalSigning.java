...
public class LocalSigning {
    ...
    private void submitSignAndBroadcast() throws MalformedURLException {
        URL localUrl = new URL("http://localhost:6868/nxt"); // Start your local main node and make sure it is fully synced with the blockchain
        URL remoteUrl = new URL("https://ndxseed.npay.life/nxt"); // nDEX Network remote main node
