...
public final class Nxt {
    ...
    static {
        ...
        if (!VERSION.equals(Nxt.defaultProperties.getProperty("nxt.version"))) {
            throw new RuntimeException("Use correct version properties file from a version other than " + VERSION + " is not supported!!!");
        }
    }
    ...
    private static class Init {
        ...
        static {
            try {
                ...
                Logger.logMessage("Copyright © 2018-2020 The nDEX Network");
