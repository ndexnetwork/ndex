...
### Usable URLs ###
  ...
  - **API** - http://localhost:6868/test
  - **DB Interface** - http://localhost:6868/dbshell
  - **Java Class Browser** - http://localhost:6868/doc
...
### Testing ###
  ...
  - all API calls can be tested manually from the auto-generated http://localhost:6868/test page
...
The NDX wallet UI run as a mobile app.
