...
gpg --detach-sign --armour --sign-with 0xB3E38C4A2BBDBA1E ${PACKAGE}.zip
gpg --detach-sign --armour --sign-with 0xB3E38C4A2BBDBA1E ${PACKAGE}.sh
#gpg --detach-sign --armour --sign-with 0xB3E38C4A2BBDBA1E ${PACKAGE}.exe

gpg --clearsign --sign-with 0xB3E38C4A2BBDBA1E ${CHANGELOG}
rm -f ${CHANGELOG}
